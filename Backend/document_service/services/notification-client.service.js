...
export const resolveNotificationUserId = (payload = {}, fallbackDocument = null) => {
  return payload.userId
    || payload.requesterId
    || payload.ownerUserId
    || fallbackDocument?.ownerUserId
    || null;
};
...
export const sendNotification = async (payload) => {
  ...
  try {
    ...
    console.error("Notification dispatch failed in document service:", error.message);
  } finally {
